---
title: Ruffed Grouse - G&amp;eacute;linotte hupp&amp;eacute;e
subtitle: (_Bonasa umbellus_)
---

The population size of Ruffed Grouse in the Ring of Fire region was 0.392 (0.307, 0.474) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/RUGR/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/RUGR/density.png)
