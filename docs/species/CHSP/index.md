...
The population size of Chipping Sparrow (Bruant familier) in the Ring of Fire region was 5.492 (4.757, 6.132) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/CHSP/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/CHSP/density.png)
