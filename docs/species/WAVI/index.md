---
title: Warbling Vireo - Vir&amp;eacute;o m&amp;eacute;lodieux
subtitle: (_Vireo gilvus_)
---

The population size of Warbling Vireo in the Ring of Fire region was 0.014 (0.001, 0.032) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/WAVI/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/WAVI/density.png)
