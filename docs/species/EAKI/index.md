...
The population size of Eastern Kingbird (Tyran tritri) in the Ring of Fire region was 0.077 (0.05, 0.115) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/EAKI/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/EAKI/density.png)
