---
title: Clay-colored Sparrow - Bruant des plaines
subtitle: (_Spizella pallida_)
---

The population size of Clay-colored Sparrow in the Ring of Fire region was 0.353 (0.285, 0.44) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/CCSP/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/CCSP/density.png)
