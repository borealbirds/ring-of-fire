---
title: Bay-breasted Warbler - Paruline &amp;agrave; poitrine baie
subtitle: (_Setophaga castanea_)
---

The population size of Bay-breasted Warbler in the Ring of Fire region was 3.106 (2.622, 3.621) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/BBWA/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/BBWA/density.png)
