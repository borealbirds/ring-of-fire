---
title: Mourning Warbler - Paruline triste
subtitle: (_Geothlypis philadelphia_)
---

The population size of Mourning Warbler in the Ring of Fire region was 2.841 (2.35, 3.237) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/MOWA/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/MOWA/density.png)
