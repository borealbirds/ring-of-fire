...
The population size of Fox Sparrow (<div>Bruant fauve</div>) in the Ring of Fire region was 3.054 (2.609, 3.383) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/FOSP/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/FOSP/density.png)
