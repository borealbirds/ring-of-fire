---
title: American Tree Sparrow - Bruant hudsonien
subtitle: (_Spizella arborea_)
---

The population size of American Tree Sparrow in the Ring of Fire region was 0.024 (0, 0.115) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/ATSP/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/ATSP/density.png)
