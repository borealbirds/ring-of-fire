...
The population size of Varied Thrush (Grive &amp;agrave; collier) in the Ring of Fire region was 0 (0, 0) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/VATH/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/VATH/density.png)
