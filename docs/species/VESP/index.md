---
title: Vesper Sparrow - Bruant vesp&amp;eacute;ral
subtitle: (_Pooecetes gramineus_)
---

The population size of Vesper Sparrow in the Ring of Fire region was 0.032 (0.019, 0.045) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/VESP/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/VESP/density.png)
