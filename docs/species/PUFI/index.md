---
title: Purple Finch - Roselin pourpr&amp;eacute;
subtitle: (_Carpodacus purpureus_)
---

The population size of Purple Finch in the Ring of Fire region was 1.64 (0.96, 2.615) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/PUFI/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/PUFI/density.png)
