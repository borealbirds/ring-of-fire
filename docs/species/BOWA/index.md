---
title: Bohemian Waxwing - Jaseur bor&amp;eacute;al
subtitle: (_Bombycilla garrulus_)
---
...
![Distribution map]({{ site.baseurl }}/species/BOWA/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/BOWA/density.png)
