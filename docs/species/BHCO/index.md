...
The population size of Brown-headed Cowbird (Vacher &amp;agrave; t&amp;ecirc;te brune) in the Ring of Fire region was 0.152 (0.095, 0.211) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/BHCO/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/BHCO/density.png)
