---
title: Common Yellowthroat - Paruline masqu&amp;eacute;e
subtitle: (_Geothlypis trichas_)
---

The population size of Common Yellowthroat in the Ring of Fire region was 3.917 (3.281, 4.484) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/COYE/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/COYE/density.png)
