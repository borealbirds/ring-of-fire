...
The population size of Connecticut Warbler (Paruline &amp;agrave; gorge grise) in the Ring of Fire region was 0.219 (0.155, 0.279) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/CONW/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/CONW/density.png)
