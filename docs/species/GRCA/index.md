...
The population size of Gray Catbird (Moqueur chat) in the Ring of Fire region was 0.082 (0.058, 0.109) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/GRCA/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/GRCA/density.png)
