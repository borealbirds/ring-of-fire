...
The population size of Ovenbird (Paruline couronn&amp;eacute;e) in the Ring of Fire region was 4.074 (3.447, 4.604) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/OVEN/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/OVEN/density.png)
