---
title: Marsh Wren - Troglodyte des marais
subtitle: (_Cistothorus palustris_)
---

The population size of Marsh Wren in the Ring of Fire region was 0.005 (0, 0.011) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/MAWR/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/MAWR/density.png)
