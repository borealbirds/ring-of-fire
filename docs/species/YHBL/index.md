---
title: Yellow-headed Blackbird - Carouge &amp;agrave; t&amp;ecirc;te jaune
subtitle: (_Xanthocephalus xanthocephalus_)
---

The population size of Yellow-headed Blackbird in the Ring of Fire region was 0 (0, 0) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/YHBL/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/YHBL/density.png)
