---
title: Eastern Towhee - Tohi &amp;agrave; flancs roux
subtitle: (_Pipilo erythrophthalmus_)
---

The population size of Eastern Towhee in the Ring of Fire region was 0.001 (0, 0.004) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/EATO/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/EATO/density.png)
