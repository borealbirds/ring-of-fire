...
The population size of Song Sparrow (Bruant chanteur) in the Ring of Fire region was 1.715 (1.502, 1.997) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/SOSP/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/SOSP/density.png)
