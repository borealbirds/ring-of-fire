---
title: Upland Sandpiper - Maub&amp;egrave;che des champs
subtitle: (_Bartramia longicauda_)
---

The population size of Upland Sandpiper in the Ring of Fire region was 0 (0, 0) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/UPSA/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/UPSA/density.png)
