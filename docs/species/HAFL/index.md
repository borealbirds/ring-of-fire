---
title: Hammond's Flycatcher - Moucherolle de Hammond
subtitle: (_Empidonax hammondii_)
---

The population size of Hammond's Flycatcher in the Ring of Fire region was 0 (0, 0) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/HAFL/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/HAFL/density.png)
