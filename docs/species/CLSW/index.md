...
The population size of Cliff Swallow (Hirondelle &amp;agrave; front blanc) in the Ring of Fire region was 0.136 (0.009, 0.331) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Density by land cover type]({{ site.baseurl }}/species/CLSW/density.png)
