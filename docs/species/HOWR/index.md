---
title: House Wren - Troglodyte familier
subtitle: (_Troglodytes aedon_)
---

The population size of House Wren in the Ring of Fire region was 0.037 (0.02, 0.055) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/HOWR/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/HOWR/density.png)
