---
title: Wood Thrush - Grive des bois
subtitle: (_Hylocichla mustelina_)
---

The population size of Wood Thrush in the Ring of Fire region was 0.006 (0.002, 0.01) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/WOTH/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/WOTH/density.png)
