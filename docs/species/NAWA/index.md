---
title: Nashville Warbler - Paruline &amp;agrave; joues grises
subtitle: (_Oreothlypis ruficapilla_)
---

The population size of Nashville Warbler in the Ring of Fire region was 9.066 (8.304, 9.65) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/NAWA/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/NAWA/density.png)
