---
title: Greater Yellowlegs - Grand Chevalier
subtitle: (_Tringa melanoleuca_)
---

The population size of Greater Yellowlegs in the Ring of Fire region was 0.553 (0.39, 0.735) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).
...
![Distribution map]({{ site.baseurl }}/species/GRYE/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/GRYE/density.png)
