...
The population size of Pileated Woodpecker (Grand Pic) in the Ring of Fire region was 0.242 (0.194, 0.283) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/PIWO/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/PIWO/density.png)
