---
title: Veery - Grive fauve
subtitle: (_Catharus fuscescens_)
---

The population size of Veery in the Ring of Fire region was 1.045 (0.874, 1.231) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/VEER/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/VEER/density.png)
