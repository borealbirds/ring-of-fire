...
The population size of Olive-sided Flycatcher (Moucherolle &amp;agrave; c&amp;ocirc;t&amp;eacute;s olive) in the Ring of Fire region was 0.365 (0.279, 0.428) million individuals based on the [BAM National Models](https://dx.doi.org/10.5281/zenodo.4018335).

# Maps

Mean density (males per ha) is the average of 32 bootstrap based prediction maps.

![Distribution map]({{ site.baseurl }}/species/OSFL/map.png)
...
![Density by land cover type]({{ site.baseurl }}/species/OSFL/density.png)
